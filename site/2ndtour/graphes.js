...
function dashboard2(id, fData){
    ...
    function histoGram(fD){
        ...
        bars.append("text").style("font-size","18").text(function(d){ return d3.format(",")(d[1])})
		...
		bars.append("text")
            ...
            .style("font-family", "sans-serif").style("font-size","20").text("Date du sondage");


		bars.append("text")
            .attr("text-anchor", "middle")  // this makes it easy to centre the text as the transform is applied to the anchor
            .attr("transform", "translate("+ (-10) +","+(hGDim.h/2)+")rotate(-90)")  // text is drawn off the screen top left, move down and out and rotate
            .style("font-size","19").style("font-family", "sans-serif")
			.text("Intention de vote pour le candidat (%)");
	...
	//.attr("transform", "translate("+"300"+","+"50"+")");
		...
		svg.append("svg:text")
            ...
            .style("font-family", "sans-serif").style("font-size","20").text("Intentions de vote à la date sélectionnée");
